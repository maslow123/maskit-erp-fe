    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex">
        ...
        <form className="relative flex flex-1" action="#" method="GET">
          ...
          <input
            id="search-field"
            className={`border-1 block ${isFinance ? 'h-[40px]' : 'h-full'} w-full rounded border-[#D9D9D9] py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm`}
